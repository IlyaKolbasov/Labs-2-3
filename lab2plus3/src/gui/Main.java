...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Label startLabelMaster = new Label("Выбор Действия:");
        gridpane.add(startLabelMaster, 0, 0, 2, 1);

        Label startLabelPet = new Label("Другие животные:");
        gridpane.add(startLabelPet, 2, 0, 2, 1);

        Label dogLabel = new Label("Выбрать собаку:");
